...
- Gérer au moyen d'exceptions le cas où une position de pizzeria choisie au hasard est trop proche d'une pizzeria existante (faire une constante qui définit la distance minimale entre deux pizzerias)
